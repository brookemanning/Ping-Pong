...
%for the visuals, Yuki used the command figure and a rectangle as a
...
function condensedpingpongsetup()
...
%mode selector starts HERE ------------------
    ...
    function starteasy(~,~)
        ...
        speedLevel = 0.03;
        pingpong(ballvelocity, speedLevel);
    end
...
%game code starts HERE ------------------
    function pingpong(ballvelocity, speedLevel)
    ...
    %SCORING --
        ...
        % checking collisions
            ...
            if inbounds_paddleAx && inbounds_paddleAy
                ballvelocity(1) = -ballvelocity(1) * (1 + randn * 0.2);
            end
